...
const Thankyou = () => {
  ...
  return (
    <>
      ...
      <Text as="p" {...paragraphProps}>
        <b>{`플라스틱 오염 없는 세상을 위해 ${signup?.LastName}님의 후원이 꼭 필요합니다.`}</b>
      </Text>
      ...
      <Text as="li" {...lineProps}>
      연간 2,000명 이상의 시민 봉사자들과 해변 청소, 플로깅 등 오프라인 시민운동을 연 4회 이상 진행하는데 후원금이 사용됩니다.
      </Text>

      <Text as="li" {...lineProps}>
      법적 절차에 따라 화석연료, 플라스틱 제조사에 플라스틱 생산량, 사용량 공개를 요구하고, 기후변화에 대한 책임을 묻고 불필요한 일회용 플라스틱 생산을 막을 수 있습니다.
      </Text>
