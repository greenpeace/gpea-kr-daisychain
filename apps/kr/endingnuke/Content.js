...
const Content = ({ theme }) => {
  ...
  return (
    <div>
      ...
      <Text as="p" {...paragraphProps}>
        노후한 원자력발전소의 안전 문제는 심각해지고, 위험요소는 증가하지만 안전 규제는 더욱 완화되고 있습니다. 산불 위험 지대인 울진은 이미 아시아 최대 규모의 원전 부지입니다. 수만년이 넘는 저장 기간 중 언제나 방사능 사고의 원인이 될 수 있는 사용후핵연료는 이미 포화 상태입니다.  
      </Text>

      <Text as="p" {...paragraphProps}>
        우리에겐 아직 또 다른 원전 사고를 막을 수 있는 시간이 있습니다. 그래서, 지금 우리가 내릴 선택이 더욱 중요합니다.
      </Text>
      ...
      <Text as="p" {...paragraphProps}>
        {`원전 제일주의로는 우리의 안전을 장담할 수 없습니다. 그린피스는 '원전 말고 안전' 캠페인을 통해 원자력발전소 내부 주요 시설의 기술적 결함, 원자력안전법과 관련 규제 사각지대에 놓인 안전 문제 해결에 기여하고 있습니다.`}
      </Text>
