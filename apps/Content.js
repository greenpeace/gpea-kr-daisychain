...
const Content = ({ theme }) => {
  ...
  return (
    <>
      ...
      <Text as="p" {...paragraphProps}>
      세계 곳곳에서는 산림 보호지역을 지키고 생물다양성을 보존하기 위해 다양한 움직임이 일어나고 있습니다. 그린피스는 2030년까지 육상과 해양 보호지역이 최소 30%까지 확대되고 보호지역이 보호될 될 수 있도록 정부에 촉구하고 있습니다.
      </Text>
      ...
      <Text as="p" {...paragraphProps}>
      숲은 깨끗한 공기와 시원한 그늘을 제공하고 다양한 동식물의 터전입니다. 수많은 탄소를 흡수해 기후위기를 막아내는 역할도 합니다. 자연이 우리에게 준 선물, 이제 우리가 돌려줄 때입니다.
      </Text>
